...
winds[[2]] <- matrix(c(0,.5,0,0,0,.5,1,2,0,0,1,3,0,1,0,0.5,1,2,0,0,0,.5,0,0,0), ncol=5,
                   byrow = T)
winds[[3]] <- matrix(c(rep(0,8),0.5,1,rep(0,4),0.5,1,2,1,rep(0,3),1,3,5,0,.5,0,0,.5,1,2,1,
                      rep(0,4), 0.5,1,rep(0,11)), ncol=7, byrow=T)
